...
class PresupuestoAsistente implements Agent,  HasTools
{
    use Promptable;
    public int $presupuestoID = 0;
    public string $presupuestoContext = '';
    ...
    public function tools(): iterable
    {
        ...
        return [
            new SearchExpenses($this->presupuestoID),
            new AddExpenses($this->presupuestoID, $this->hasCategories)
        ];
    }
}
