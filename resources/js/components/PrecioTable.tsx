    ...
    return (
        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-10">
                {/* Plan Mensual */}
                <div className="rounded-lg border border-gray-300 p-6 card">
                    <h3 className="text-xl font-bold text-purple-800">Mensual</h3>
                    <p className="mt-2">
                        <span className="text-6xl font-medium">$10</span>
                ...
                {/* Plan Anual */}
                <div className="rounded-lg border-2 border-purple-950 p-6 relative card">
                    ...
                    <p className="text-sm text-gray-500">Equivale a $8.5/mes</p>
                    <ul className="mt-4 space-y-2 text-lg">
